...
CREATE TABLE `tb_item` (
  ...
  `cid` bigint(11) NOT NULL DEFAULT '0' COMMENT '所属分类',
  `status` int(1) NOT NULL DEFAULT '1' COMMENT '商品状态 1正常 0下架',
...
-- Records of tb_item
-- ----------------------------
INSERT INTO `tb_item` VALUES ('679532', 'Smartisan 原装快充充电器 18W', '18W 安全快充、支持主流 QC3.0, MTK PE+2.0 快充协议', '59.00', 'http://image.smartisanos.cn/resource/dc53bd870ee64d2053ecc51750ece43a.jpg', '560', '1', '2017-09-05 21:27:54', '2017-11-09 22:31:04');
INSERT INTO `tb_item` VALUES ('679533', 'Smartisan 坚果自拍杆', '通用 3.5 mm 接口、航空铝合金伸缩杆、防过敏硅胶手柄', '69.00', 'http://image.smartisanos.cn/resource/afe5728faa22f4b078b84d9c725c136d.jpg', '560', '1', '2017-09-05 21:27:54', '2017-09-05 21:29:54');
INSERT INTO `tb_item` VALUES ('691300', 'Smartisan 快充移动电源 10000mAh', '10000mAh 双向快充、轻盈便携、高标准安全保护', '199.00', 'http://image.smartisanos.cn/resource/0540778097a009364f2dcbb8c5286451.jpg', '560', '1', '2017-09-05 21:27:54', '2017-11-09 22:22:53');
INSERT INTO `tb_item` VALUES ('738388', 'Smartisan 原装 Type-C 数据线', 'PTC 过温保护、凹形设计、TPE 环保材质', '39.00', 'http://image.smartisanos.cn/resource/c79a73ffc6f8e782160d978f49f543dc.jpg', '560', '1', '2017-09-05 21:27:54', '2017-10-22 22:15:02');
...
INSERT INTO `tb_item` VALUES ('830972', '《深泽直人》', '首次面向中国读者介绍其作品', '199.00', 'http://image.smartisanos.cn/resource/5e4e40120d09fb6791f9430f914c6f68.jpg', '560', '1', '2017-09-05 21:27:54', '2017-09-05 21:29:54');
...
INSERT INTO `tb_item` VALUES ('150642571432842', '坚果 3 \"足迹\"背贴 乐高创始人出生', '1891 年 4 月 7 日', '79.00', 'https://resource.smartisan.com/resource/abb6986430536cd9365352b434f3c568.jpg', '560', '0', '2018-04-19 00:45:14', '2018-04-20 00:08:21');
...
CREATE TABLE `tb_item_category` (
  ...
  `parent_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '父分类ID=0时代表一级根分类',
  `name` varchar(50) NOT NULL DEFAULT '' COMMENT '分类名称',
  `status` int(1) NOT NULL DEFAULT '1' COMMENT '状态 1启用 0禁用',
  `sort_order` int(4) NOT NULL DEFAULT '0' COMMENT '排列序号',
...
CREATE TABLE `tb_item_sales` (
  ...
  `limit_num` bigint(11) NOT NULL COMMENT '购买限制数量',
  `sales` bigint(11) NOT NULL DEFAULT '0',
...
INSERT INTO `tb_member` VALUES ('6', '小龙女', '107', '107@qq.com', '2019-08-07 10:14:01', '2019-08-15 10:14:05', '女', '古墓', '2', '', '', '0', '0.00');
...
INSERT INTO `tb_member` VALUES ('10', '萧炎', '111', '111@qq.com', '2015-01-01 00:00:00', '2019-08-07 16:08:51', '男', '中州', '1', '', '炎帝', '0', '0.00');
...
INSERT INTO `tb_member` VALUES ('83', 'user', '15211111111', '9695@qq.com', '2019-08-07 14:09:50', '2019-08-08 01:48:12', '男', '北京市北京市市辖区东城区', '2', '', '', '0', '0.00');
...
INSERT INTO `tb_member` VALUES ('86', '小柒', '15304727515', '1054534@qq.com', '2015-01-01 00:00:00', '2015-01-01 00:00:00', '女', '北京市北京市市辖区东城区', '1', '', '', '0', '0.00');
...
CREATE TABLE `tb_order` (
  ...
  `payment_type` int(1) NOT NULL DEFAULT '0' COMMENT '支付类型 1在线支付 2货到付款',
  `post_fee` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '邮费',
  `status` int(1) NOT NULL DEFAULT '0' COMMENT '状态 0未付款 1已付款 2未发货 3已发货 4交易成功 5交易关闭 6交易失败',
...
CREATE TABLE `tb_panel` (
  ...
  `type` int(1) NOT NULL DEFAULT '0' COMMENT '类型 0轮播图 1板块种类一 2板块种类二 3板块种类三 ',
  `sort_order` int(4) NOT NULL DEFAULT '0' COMMENT '排列序号',
  `position` int(1) NOT NULL DEFAULT '0' COMMENT '所属位置 0首页 1商品推荐 2我要捐赠',
  `limit_num` int(4) NOT NULL DEFAULT '4' COMMENT '板块限制商品数量',
...
INSERT INTO `tb_panel` VALUES ('9', '活动版块2', '1', '7', '0', '4', '1', '', '2010-10-04 09:50:18', '2018-04-19 11:57:47');
...
CREATE TABLE `tb_panel_content` (
  ...
  `type` int(1) NOT NULL COMMENT '类型 0关联商品 1其他链接',
  `product_id` bigint(20) NOT NULL COMMENT '关联商品id',
  `sort_order` int(4) NOT NULL,
  `full_url` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '其他链接',
  `pic_url` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `pic_url2` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '3d轮播图备用',
  `pic_url3` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '3d轮播图备用',
  `created` datetime NOT NULL,
  `updated` datetime NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `tb_panel_content` VALUES ('22', '1', '0', '150635087972564', '1', '', 'http://ow2h3ee9w.bkt.clouddn.com/FjvP4gBFeYGQoEtEX7dL3kbwJTDW', '', '', '2017-10-22 22:26:31', '2017-10-22 22:26:31');
INSERT INTO `tb_panel_content` VALUES ('23', '1', '0', '150642571432835', '2', '', 'http://ow2h3ee9w.bkt.clouddn.com/FgwHSk1Rnd-8FKqNJhFSSdcq2QVB', '', '', '2017-10-22 22:26:40', '2018-04-17 20:59:35');
INSERT INTO `tb_panel_content` VALUES ('25', '8', '0', '150642571432835', '1', '', 'https://resource.smartisan.com/resource/6/610400xinpinpeijian.jpg', '', '', '2018-04-15 19:07:43', '2018-04-19 23:20:34');
...
INSERT INTO `tb_panel_content` VALUES ('28', '8', '0', '150635087972564', '4', '', 'https://resource.smartisan.com/resource/fe6ab43348a43152b4001b4454d206ac.jpg', '', '', '2018-04-15 19:08:58', '2018-04-19 23:21:13');
...
INSERT INTO `tb_panel_content` VALUES ('32', '7', '0', '150635087972564', '1', '', 'http://static.smartisanos.cn/index/img/store/home/banner-3d-item-1-box-1_61bdc2f4f9.png', '', '', '2018-04-17 20:41:02', '2018-04-17 20:58:41');
INSERT INTO `tb_panel_content` VALUES ('33', '7', '0', '150642571432835', '2', '', 'http://oweupqzdv.bkt.clouddn.com/bg_left.png', '', '', '2018-04-17 21:08:22', '2018-04-20 10:47:19');
INSERT INTO `tb_panel_content` VALUES ('34', '7', '0', '150635087972564', '3', '', 'https://s1.ax1x.com/2018/05/19/Ccdiid.png', '', '', '2018-04-17 21:08:30', '2018-04-17 21:08:32');
INSERT INTO `tb_panel_content` VALUES ('35', '7', '0', '150642571432843', '4', '', 'http://ow2h3ee9w.bkt.clouddn.com/24401108web1.png', '', '', '2018-04-18 23:44:48', '2018-04-20 11:41:46');
...
INSERT INTO `tb_panel_content` VALUES ('47', '6', '0', '150635087972564', '1', '', 'http://ow2h3ee9w.bkt.clouddn.com/FjvP4gBFeYGQoEtEX7dL3kbwJTDW', '', '', '2018-04-19 11:15:35', '2018-04-19 11:15:35');
INSERT INTO `tb_panel_content` VALUES ('48', '6', '0', '150642571432835', '2', '', 'http://ow2h3ee9w.bkt.clouddn.com/FgwHSk1Rnd-8FKqNJhFSSdcq2QVB', '', '', '2018-04-19 11:18:16', '2018-04-19 11:18:18');
...
INSERT INTO `tb_panel_content` VALUES ('51', '7', '0', '150635087972564', '5', '', 'http://ow2h3ee9w.bkt.clouddn.com/417pcchunrihaolishouji.png', '', '', '2018-04-19 15:09:40', '2018-04-19 21:16:04');
...
INSERT INTO `tb_panel_content` VALUES ('60', '0', '0', '127435', '4', '', 'XPay支付系统', '', '', '2018-07-27 22:26:03', '2018-07-27 22:26:50');
INSERT INTO `tb_panel_content` VALUES ('61', '0', '0', '1234', '5', '', 'XBoot框架', '', '', '2018-07-27 22:26:21', '2018-07-27 22:26:47');
INSERT INTO `tb_panel_content` VALUES ('62', '0', '0', '734312', '6', '', '宣传视频', '', '', '2018-07-27 22:26:44', '2018-07-27 22:26:44');
INSERT INTO `tb_panel_content` VALUES ('63', '0', '0', '573274', '7', '', 'Github', '', '', '2018-07-27 22:27:22', '2018-07-27 22:27:26');
...
INSERT INTO `tb_password` VALUES ('12', '', '0', '86');
...
CREATE TABLE `video_info` (
  `id` bigint(20) NOT NULL,
  `user_id` bigint(20) NOT NULL DEFAULT '0',
  `audio_id` bigint(20) NOT NULL DEFAULT '0',
  `video_title` varchar(128) NOT NULL DEFAULT '' COMMENT '视频标题',
  `video_path` varchar(255) NOT NULL DEFAULT '' COMMENT '视频路径',
  `video_second` float(6,2) NOT NULL DEFAULT '0.00' COMMENT '视频持续时间',
...
-- ----------------------------
-- Table structure for video_report
-- ----------------------------
DROP TABLE IF EXISTS `video_report`;
CREATE TABLE `video_report` (
  `id` bigint(20) NOT NULL DEFAULT '0',
  `reported_user_id` bigint(255) NOT NULL,
  `reported_video_id` bigint(20) NOT NULL,
  `title` varchar(128) NOT NULL,
  `content` varchar(255) NOT NULL COMMENT '举报用户id',
...
-- ----------------------------
-- Records of video_report
-- ----------------------------

-- ----------------------------
-- Table structure for video_search_record
-- ----------------------------
DROP TABLE IF EXISTS `video_search_record`;
CREATE TABLE `video_search_record` (
  `id` bigint(20) NOT NULL,
...
-- ----------------------------
-- Records of video_search_record
-- ----------------------------

-- ----------------------------
-- Table structure for video_user_fan
-- ----------------------------
DROP TABLE IF EXISTS `video_user_fan`;
CREATE TABLE `video_user_fan` (
  `id` bigint(20) NOT NULL,
  `user_id` bigint(20) NOT NULL DEFAULT '0',
...
-- ----------------------------
-- Records of video_user_fan
-- ----------------------------

-- ----------------------------
-- Table structure for video_user_info
-- ----------------------------
DROP TABLE IF EXISTS `video_user_info`;
CREATE TABLE `video_user_info` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `reveive_like_count` int(11) NOT NULL DEFAULT '0' COMMENT '点赞数',
